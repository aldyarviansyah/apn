        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <form class="apn-form" action="{{ route('access-requests.approve', $detail) }}" method="post">
                        @csrf
                        <div class="form-section mb-40">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control gmod @error('full_name') is-invalid @enderror" name="full_name" value="{{ old('full_name', $detail->name) }}">
                                <div class="o5 mt-1">@lang('users.login_username_note')</div>
                                @error('full_name')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control text-lowercase gmod @error('email') is-invalid @enderror" name="email" value="{{ old('email', $detail->company_email) }}" onkeyup="this.value = this.value.toLowerCase();">
                                @error('email')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-10">
                                    <a href="{{ url()->previous() }}" class="btn btn-light btn-block mb-10 gmod-btn pop-onclick">@lang('global.back')</a>
                                </div>
                            </div>
                        </div>
                    </form>
