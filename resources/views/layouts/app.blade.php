...
<div id="ui-general">
    <!-- Nav -->
    <div id="overlay"></div>
    <livewire:components.page-nav :title="$title"/>
    <livewire:components.side-nav/>
@include('layouts.includes.navMeta')
<!-- Trays -->
    {{--    @include('layouts.includes.trays')--}}
</div>
@yield('content')
