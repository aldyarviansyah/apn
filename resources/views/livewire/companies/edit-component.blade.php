                    ...
                    <form class="apn-form">
                        ...
                        <div class="form-section mb-40">
                            <div class="form-group">
                                ...
                                <a href="#" class="btn btn-outline btn-block mb-10 gmod-btn scale justify-content-start open-tray pop-onclick" data-target="select-users" wire:click="openSelect('user')">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6 mb-10">
                                    <button type="button" wire:click="storeSubmit" class="btn btn-primary btn-block gmod-btn scale add-spinner white-spinner">Update</button>
                                </div>
                                <div class="col-md-6 mb-10">
