<div class="tray-views">
        ...
        @if($detail)
            <div class="data-info-body">
                ...
                <div class="view-more-tools d-none">
                    @can('boats-update')
                        <div class="data-item cursor-ptr add-spinner div-href" data-url="{{ route('boats.edit', $detail) }}">
                            <a href="{{ route('boats.edit', $detail) }}" class="data-info-action">Update</a>
                        </div>
                    @endcan
                </div>
    ...
    <div class="ui-tray ship-search-tray">
        ...
        <div class="data-info-body">
            <div class="tray-form pb-10">
                <form action="{{ route('boats') }}">
                    @foreach(request()->query() as $key => $value)
                        @if($key != 'keyword' && $key!='page' && $key!='column')
                    ...
                    <div class="form-group">
                        <select class="custom-select" name="column">
                            <option value="name" {{ $column=='name'?'selected':'' }}>Boat name</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <div class="form-group">
    ...
    <div class="ui-tray tools-tray">
        ...
        <div class="data-info-body">
            <div class="tray-form pb-10">
                <div class="form-group">
                    <a href="{{ route('boats.create') }}" class="btn btn-primary btn-block gmod-btn pop-onclick add-spinner white-spinner">
